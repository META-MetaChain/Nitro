...
func main() {
	...
	upgExecutorPath := filepath.Join(parent, "contracts", "node_modules", "@META-MetaChain", "upgrade-executor", "build", "contracts", "src", "UpgradeExecutor.sol", "UpgradeExecutor.json")
