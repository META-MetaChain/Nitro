...
func TestSlotAddress(t *testing.T) {
	for _, tc := range []struct {
	...
	}{
		{
			...
			args: [][]byte{
				common.FromHex("0x03d49b54FbB71476FaaEB885BEa301086A92e0a6"), // mainnet batch poster address
				{3},
			},
		...
		},
		{
			...
			args: [][]byte{
				common.FromHex("0x03d49b54FbB71476FaaEB885BEa301086A92e0a6"), // mainnet sequencer address
				{1},
			},
