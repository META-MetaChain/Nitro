...
var (
	sourcesConnectedGauge    = metrics.NewRegisteredGauge("META/feed/sources/connected", nil)
	sourcesDisconnectedGauge = metrics.NewRegisteredGauge("META/feed/sources/disconnected", nil)
)
...
type BroadcastClient struct {
	...
	websocketUrl string
	nextSeqNum   METAutil.MessageIndex
...
func NewBroadcastClient(
	...
	txStreamer TransactionStreamerInterface,
	confirmedSequencerNumberListener chan METAutil.MessageIndex,
	fatalErrChan chan error,
...
func (bc *BroadcastClient) connect(ctx context.Context, nextSeqNum METAutil.MessageIndex) (io.Reader, error) {
	...
	log.Info("connecting to metachain inbox message broadcaster", "url", bc.websocketUrl)
