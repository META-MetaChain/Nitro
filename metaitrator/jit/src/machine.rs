...
use crate::{
    METAcompress, gostack::GoRuntimeState, runtime, socket, syscall, syscall::JsRuntimeState,
    wavmio, wavmio::Bytes32, Opts,
};

use METAutil::{Color, PreimageType};
...
pub fn create(opts: &Opts, env: WasmEnv) -> (Instance, FunctionEnv<WasmEnv>, Store) {
    ...
    let imports = imports! {
        "go" => {
            ...
            "github.com/META-MetaChain/nitro/wavmio.getGlobalStateBytes32" => func!(wavmio::get_global_state_bytes32),
            "github.com/META-MetaChain/nitro/wavmio.setGlobalStateBytes32" => func!(wavmio::set_global_state_bytes32),
            "github.com/META-MetaChain/nitro/wavmio.getGlobalStateU64" => func!(wavmio::get_global_state_u64),
            "github.com/META-MetaChain/nitro/wavmio.setGlobalStateU64" => func!(wavmio::set_global_state_u64),
            "github.com/META-MetaChain/nitro/wavmio.readInboxMessage" => func!(wavmio::read_inbox_message),
            "github.com/META-MetaChain/nitro/wavmio.readDelayedInboxMessage" => func!(wavmio::read_delayed_inbox_message),
            "github.com/META-MetaChain/nitro/wavmio.resolvePreImage" => {
            ...
            "github.com/META-MetaChain/nitro/wavmio.resolveTypedPreimage" => func!(wavmio::resolve_typed_preimage),

            "github.com/META-MetaChain/nitro/METAcompress.brotliCompress" => func!(METAcompress::brotli_compress),
            "github.com/META-MetaChain/nitro/METAcompress.brotliDecompress" => func!(METAcompress::brotli_decompress),
        },
    };
