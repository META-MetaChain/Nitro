...
#[no_mangle]
pub unsafe extern "C" fn METAitrator_load_machine(
    binary_path: *const c_char,
    library_paths: *const *const c_char,
    library_paths_size: isize,
) -> *mut Machine {
    match METAitrator_load_machine_impl(binary_path, library_paths, library_paths_size) {
        Ok(mach) => mach,
        Err(err) => {
...
unsafe fn METAitrator_load_machine_impl(
    binary_path: *const c_char,
    library_paths: *const *const c_char,
    library_paths_size: isize,
) -> Result<*mut Machine> {
...
#[no_mangle]
pub unsafe extern "C" fn METAitrator_load_wavm_binary(binary_path: *const c_char) -> *mut Machine {
    let binary_path = cstr_to_string(binary_path);
    let binary_path = Path::new(&binary_path);
...
#[no_mangle]
pub unsafe extern "C" fn METAitrator_free_machine(mach: *mut Machine) {
    drop(Box::from_raw(mach));
}

#[no_mangle]
pub unsafe extern "C" fn METAitrator_clone_machine(mach: *mut Machine) -> *mut Machine {
...
#[no_mangle]
pub unsafe extern "C" fn METAitrator_step(
    mach: *mut Machine,
    num_steps: u64,
    condition: *const u8,
) -> *mut libc::c_char {
...
#[no_mangle]
pub unsafe extern "C" fn METAitrator_add_inbox_message(
    mach: *mut Machine,
...
/// Like METAitrator_step, but stops early if it hits a host io operation.
/// Returns a c string error (freeable with libc's free) on error, or nullptr on success.
#[no_mangle]
pub unsafe extern "C" fn METAitrator_step_until_host_io(
    mach: *mut Machine,
    condition: *const u8,
) -> *mut libc::c_char {
    let mach = &mut *mach;
...
#[no_mangle]
pub unsafe extern "C" fn METAitrator_serialize_state(
    mach: *const Machine,
    path: *const c_char,
) -> c_int {
    let mach = &*mach;
...
#[no_mangle]
pub unsafe extern "C" fn METAitrator_deserialize_and_replace_state(
    mach: *mut Machine,
    path: *const c_char,
) -> c_int {
    let mach = &mut *mach;
...
#[no_mangle]
pub unsafe extern "C" fn METAitrator_get_num_steps(mach: *const Machine) -> u64 {
    (*mach).get_steps()
}

pub const METAITRATOR_MACHINE_STATUS_RUNNING: u8 = 0;
pub const METAITRATOR_MACHINE_STATUS_FINISHED: u8 = 1;
pub const METAITRATOR_MACHINE_STATUS_ERRORED: u8 = 2;
pub const METAITRATOR_MACHINE_STATUS_TOO_FAR: u8 = 3;

// Unfortunately, cbindgen doesn't support constants with non-literal values, so we assert that they're correct.
const_assert_eq!(
    METAITRATOR_MACHINE_STATUS_RUNNING,
    MachineStatus::Running as u8,
);
const_assert_eq!(
    METAITRATOR_MACHINE_STATUS_FINISHED,
    MachineStatus::Finished as u8,
);
const_assert_eq!(
    METAITRATOR_MACHINE_STATUS_ERRORED,
    MachineStatus::Errored as u8,
);
const_assert_eq!(
    METAITRATOR_MACHINE_STATUS_TOO_FAR,
    MachineStatus::TooFar as u8,
);

/// Returns one of METAITRATOR_MACHINE_STATUS_*
#[no_mangle]
pub unsafe extern "C" fn METAitrator_get_status(mach: *const Machine) -> u8 {
    (*mach).get_status() as u8
}

#[no_mangle]
pub unsafe extern "C" fn METAitrator_global_state(mach: *mut Machine) -> GlobalState {
    (*mach).get_global_state()
}

#[no_mangle]
pub unsafe extern "C" fn METAitrator_set_global_state(mach: *mut Machine, gs: GlobalState) {
...
#[no_mangle]
pub unsafe extern "C" fn METAitrator_set_preimage_resolver(
    mach: *mut Machine,
...
#[no_mangle]
pub unsafe extern "C" fn METAitrator_set_context(mach: *mut Machine, context: u64) {
    (*mach).set_context(context);
}

#[no_mangle]
pub unsafe extern "C" fn METAitrator_hash(mach: *mut Machine) -> utils::Bytes32 {
    (*mach).hash()
}

#[no_mangle]
pub unsafe extern "C" fn METAitrator_module_root(mach: *mut Machine) -> utils::Bytes32 {
    (*mach).get_modules_root()
}

#[no_mangle]
pub unsafe extern "C" fn METAitrator_gen_proof(mach: *mut Machine) -> RustByteArray {
...
#[no_mangle]
pub unsafe extern "C" fn METAitrator_free_proof(proof: RustByteArray) {
