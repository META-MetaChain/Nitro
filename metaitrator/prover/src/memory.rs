...
impl Memory {
    ...
    pub fn get_value(&self, idx: u64, ty: METAValueType, bytes: u8, signed: bool) -> Option<Value> {
        ...
        Some(match ty {
            METAValueType::I32 => Value::I32(contents as u32),
            METAValueType::I64 => Value::I64(contents as u64),
            METAValueType::F32 => {
