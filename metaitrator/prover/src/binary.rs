...
use crate::value::{METAValueType, FunctionType, IntegerValType, Value as LirValue};
    ...
    pub fn signature(&self) -> FunctionType {
        match *self {
            ...
            FloatInstruction::RelOp(t, _) => {
                FunctionType::new(vec![t.into(); 2], vec![METAValueType::I32])
            }
            ...
            FloatInstruction::F32DemoteF64 => {
                FunctionType::new(vec![METAValueType::F64], vec![METAValueType::F32])
            }
            FloatInstruction::F64PromoteF32 => {
                FunctionType::new(vec![METAValueType::F32], vec![METAValueType::F64])
            }
        }
    }
}
