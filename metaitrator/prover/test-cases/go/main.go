...
func testCompression(data []byte) {
	compressed, err := METAcompress.CompressLevel(data, 0)
	if err != nil {
		panic(err)
	}
	decompressed, err := METAcompress.Decompress(compressed, len(data)*2+0x100)
	if err != nil {
		panic(err)
	}
...
func main() {
	...
	checkPreimage := func(ty METAutil.PreimageType, hash common.Hash) {
	...
	checkPreimage(METAutil.Keccak256PreimageType, common.HexToHash("47173285a8d7341e5e972fc677286384f802f8ef42a5ec5f03bbfa254cb01fad"))
	checkPreimage(METAutil.Sha2_256PreimageType, common.HexToHash("b94d27b9934d3e08a52e52d7da7dabfac484efe37a5380ee9088f7ace2efcde9"))
