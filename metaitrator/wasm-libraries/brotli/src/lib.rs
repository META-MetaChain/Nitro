...
#[no_mangle]
pub unsafe extern "C" fn go__github_com_META-MetaChain_nitro_METAcompress_brotliDecompress(
    sp: GoStack,
) {
...
#[no_mangle]
pub unsafe extern "C" fn go__github_com_META-MetaChain_nitro_METAcompress_brotliCompress(sp: GoStack) {
