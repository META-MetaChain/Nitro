...
#[no_mangle]
pub unsafe extern "C" fn go__github_com_META-MetaChain_nitro_wavmio_getGlobalStateBytes32(
    sp: GoStack,
) {
...
#[no_mangle]
pub unsafe extern "C" fn go__github_com_META-MetaChain_nitro_wavmio_setGlobalStateBytes32(
    sp: GoStack,
) {
    let idx = sp.read_u64(0) as u32;
...
#[no_mangle]
pub unsafe extern "C" fn go__github_com_META-MetaChain_nitro_wavmio_getGlobalStateU64(sp: GoStack) {
    let idx = sp.read_u64(0) as u32;
    sp.write_u64(1, wavm_get_globalstate_u64(idx));
}

#[no_mangle]
pub unsafe extern "C" fn go__github_com_META-MetaChain_nitro_wavmio_setGlobalStateU64(sp: GoStack) {
    let idx = sp.read_u64(0) as u32;
    wavm_set_globalstate_u64(idx, sp.read_u64(1));
}

#[no_mangle]
pub unsafe extern "C" fn go__github_com_META-MetaChain_nitro_wavmio_readInboxMessage(sp: GoStack) {
...
#[no_mangle]
pub unsafe extern "C" fn go__github_com_META-MetaChain_nitro_wavmio_readDelayedInboxMessage(
    sp: GoStack,
) {
...
#[no_mangle]
pub unsafe extern "C" fn go__github_com_META-MetaChain_nitro_wavmio_resolveTypedPreimage(sp: GoStack) {
