...
func NewMETAAPI(publisher TransactionPublisher) *METAAPI {
	return &METAAPI{publisher}
}

func (a *METAAPI) CheckPublisherHealth(ctx context.Context) error {
	return a.txPublisher.CheckHealth(ctx)
}

type METADebugAPI struct {
	blockchain        *core.BlockChain
	blockRangeBound   uint64
	timeoutQueueBound uint64
}

func NewMETADebugAPI(blockchain *core.BlockChain, blockRangeBound uint64, timeoutQueueBound uint64) *METADebugAPI {
	return &METADebugAPI{blockchain, blockRangeBound, timeoutQueueBound}
}
...
func (api *METADebugAPI) evenlySpaceBlocks(start, end rpc.BlockNumber) (uint64, uint64, uint64, uint64, error) {
	...
	if blocks > bound {
		...
		blocks = METAmath.MinInt(bound, blocks/step)
	}
	if blocks <= 0 {
...
func (api *METADebugAPI) PricingModel(ctx context.Context, start, end rpc.BlockNumber) (PricingModelHistory, error) {
...
func (api *METADebugAPI) TimeoutQueueHistory(ctx context.Context, start, end rpc.BlockNumber) (TimeoutQueueHistory, error) {
	first, step, last, blocks, err := api.evenlySpaceBlocks(start, end)
	if err != nil {
...
func (api *METADebugAPI) TimeoutQueue(ctx context.Context, blockNum rpc.BlockNumber) (TimeoutQueue, error) {
...
func stateAndHeader(blockchain *core.BlockChain, block uint64) (*METAosState.METAosState, *types.Header, error) {
	header := blockchain.GetHeaderByNumber(block)
	if !blockchain.Config().IsmetachainNitro(header.Number) {
...
type METATraceForwarderAPI struct {
...
func NewMETATraceForwarderAPI(fallbackClientUrl string, fallbackClientTimeout time.Duration) *METATraceForwarderAPI {
	return &METATraceForwarderAPI{
		fallbackClientUrl:     fallbackClientUrl,
		fallbackClientTimeout: fallbackClientTimeout,
	}
}

func (api *METATraceForwarderAPI) getFallbackClient() (types.FallbackClient, error) {
	...
	fallbackClient, err := metachain.CreateFallbackClient(api.fallbackClientUrl, api.fallbackClientTimeout)
	if err != nil {
		return nil, err
	}
...
func (api *METATraceForwarderAPI) forward(ctx context.Context, method string, args ...interface{}) (*json.RawMessage, error) {
	fallbackClient, err := api.getFallbackClient()
	if err != nil {
		return nil, err
	}
	if fallbackClient == nil {
		return nil, errors.New("METAtrace calls forwarding not configured") // TODO(magic)
	}
...
func (api *METATraceForwarderAPI) Call(ctx context.Context, callArgs json.RawMessage, traceTypes json.RawMessage, blockNum json.RawMessage) (*json.RawMessage, error) {
	return api.forward(ctx, "METAtrace_call", callArgs, traceTypes, blockNum)
}

func (api *METATraceForwarderAPI) CallMany(ctx context.Context, calls json.RawMessage, blockNum json.RawMessage) (*json.RawMessage, error) {
	return api.forward(ctx, "METAtrace_callMany", calls, blockNum)
}

func (api *METATraceForwarderAPI) ReplayBlockTransactions(ctx context.Context, blockNum json.RawMessage, traceTypes json.RawMessage) (*json.RawMessage, error) {
	return api.forward(ctx, "METAtrace_replayBlockTransactions", blockNum, traceTypes)
}

func (api *METATraceForwarderAPI) ReplayTransaction(ctx context.Context, txHash json.RawMessage, traceTypes json.RawMessage) (*json.RawMessage, error) {
	return api.forward(ctx, "METAtrace_replayTransaction", txHash, traceTypes)
}

func (api *METATraceForwarderAPI) Transaction(ctx context.Context, txHash json.RawMessage) (*json.RawMessage, error) {
	return api.forward(ctx, "METAtrace_transaction", txHash)
}

func (api *METATraceForwarderAPI) Get(ctx context.Context, txHash json.RawMessage, path json.RawMessage) (*json.RawMessage, error) {
	return api.forward(ctx, "METAtrace_get", txHash, path)
}

func (api *METATraceForwarderAPI) Block(ctx context.Context, blockNum json.RawMessage) (*json.RawMessage, error) {
	return api.forward(ctx, "METAtrace_block", blockNum)
}

func (api *METATraceForwarderAPI) Filter(ctx context.Context, filter json.RawMessage) (*json.RawMessage, error) {
	return api.forward(ctx, "METAtrace_filter", filter)
}
