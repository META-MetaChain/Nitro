...
func (s *StubSignatureCheckDAS) Store(ctx context.Context, message []byte, timeout uint64, sig []byte) (*METAstate.DataAvailabilityCertificate, error) {
...
func (s *StubSignatureCheckDAS) ExpirationPolicy(ctx context.Context) (METAstate.ExpirationPolicy, error) {
