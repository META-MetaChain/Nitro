...
func (*dummyReader) ExpirationPolicy(ctx context.Context) (METAstate.ExpirationPolicy, error) {
	return -1, errors.New("not implemented")
}

func TestDAS_SimpleExploreExploit(t *testing.T) {
	readers := []METAstate.DataAvailabilityReader{&dummyReader{0}, &dummyReader{1}, &dummyReader{2}, &dummyReader{3}, &dummyReader{4}, &dummyReader{5}}
	...
	expectedOrdering := []METAstate.DataAvailabilityReader{readers[1], readers[2], readers[5], readers[4], readers[0], readers[3]}
	...
	checkMatch := func(expected, was []METAstate.DataAvailabilityReader, doMatch bool) {
