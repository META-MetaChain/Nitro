...
var uniquifyingPrefix = []byte("metachain Nitro DAS API Store:")
...
func (s *StoreSigningDAS) Store(ctx context.Context, message []byte, timeout uint64, sig []byte) (*METAstate.DataAvailabilityCertificate, error) {
