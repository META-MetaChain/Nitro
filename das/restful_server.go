...
var (
	restGetByHashRequestGauge       = metrics.NewRegisteredGauge("META/das/rest/getbyhash/requests", nil)
	restGetByHashSuccessGauge       = metrics.NewRegisteredGauge("META/das/rest/getbyhash/success", nil)
	restGetByHashFailureGauge       = metrics.NewRegisteredGauge("META/das/rest/getbyhash/failure", nil)
	restGetByHashReturnedBytesGauge = metrics.NewRegisteredGauge("META/das/rest/getbyhash/bytes", nil)
	restGetByHashDurationHistogram  = metrics.NewRegisteredHistogram("META/das/rest/getbyhash/duration", nil, metrics.NewBoundedHistogramSample())
)
...
func NewRestfulDasServer(address string, port uint64, restServerTimeouts genericconf.HTTPServerTimeoutConfig, daReader METAstate.DataAvailabilityReader, daHealthChecker DataAvailabilityServiceHealthChecker) (*RestfulDasServer, error) {
...
func NewRestfulDasServerOnListener(listener net.Listener, restServerTimeouts genericconf.HTTPServerTimeoutConfig, daReader METAstate.DataAvailabilityReader, daHealthChecker DataAvailabilityServiceHealthChecker) (*RestfulDasServer, error) {
