...
func TestStaticForwarder(t *testing.T) {
	...
	nodeConfigB := METAnode.ConfigDefaultL1Test()
...
func waitForSequencerLockout(ctx context.Context, node *METAnode.Node, duration time.Duration) error {
	if node == nil {
...
func stopNodes(nodes []*METAnode.Node) {
