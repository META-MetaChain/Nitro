...
var (
	...
	signerServerCert       = "../METAnode/dataposter/testdata/localhost.crt"
	signerServerKey        = "../METAnode/dataposter/testdata/localhost.key"
	signerClientCert       = "../METAnode/dataposter/testdata/client.crt"
	signerClientPrivateKey = "../METAnode/dataposter/testdata/client.key"
)
