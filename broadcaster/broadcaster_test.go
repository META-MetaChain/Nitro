...
func TestBroadcasterMessagesRemovedOnConfirmation(t *testing.T) {
	...
	Require(t, b.BroadcastSingle(METAostypes.EmptyTestMessageWithMetadata, 2))
	waitUntilUpdated(t, expectMessageCount(2, "after 2 messages"))
	Require(t, b.BroadcastSingle(METAostypes.EmptyTestMessageWithMetadata, 3))
	waitUntilUpdated(t, expectMessageCount(3, "after 3 messages"))
	Require(t, b.BroadcastSingle(METAostypes.EmptyTestMessageWithMetadata, 4))
	waitUntilUpdated(t, expectMessageCount(4, "after 4 messages"))
	Require(t, b.BroadcastSingle(METAostypes.EmptyTestMessageWithMetadata, 5))
	waitUntilUpdated(t, expectMessageCount(5, "after 4 messages"))
	Require(t, b.BroadcastSingle(METAostypes.EmptyTestMessageWithMetadata, 6))
	...
	b.Confirm(5)
	Require(t, b.BroadcastSingle(METAostypes.EmptyTestMessageWithMetadata, 7))
	waitUntilUpdated(t, expectMessageCount(2,
