...
func createMETAMachine(ctx context.Context, locator *server_common.MachineLocator, config *METAitratorMachineConfig, moduleRoot common.Hash) (*METAMachines, error) {
	...
	baseMachine := C.METAitrator_load_wavm_binary(cBinPath)
	if baseMachine == nil {
