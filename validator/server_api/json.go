...
import (
	...
	"github.com/META-MetaChain/nitro/util/jsonapi"
...
type ValidationInputJson struct {
	...
	HasDelayedMsg bool
	DelayedMsgNr  uint64
	PreimagesB64  map[METAutil.PreimageType]*jsonapi.PreimagesMapJson
...
func ValidationInputToJson(entry *validator.ValidationInput) *ValidationInputJson {
	jsonPreimagesMap := make(map[METAutil.PreimageType]*jsonapi.PreimagesMapJson)
