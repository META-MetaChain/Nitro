...
func NewRollupWatcher(address common.Address, client METAutil.L1Interface, callOpts bind.CallOpts) (*RollupWatcher, error) {
...
func (r *RollupWatcher) LookupNode(ctx context.Context, number uint64) (*NodeInfo, error) {
	...
	l1BlockProposed, err := METAutil.CorrespondingL1BlockNumber(ctx, r.client, ethLog.BlockNumber)
	if err != nil {
		return nil, err
	}
	return &NodeInfo{
