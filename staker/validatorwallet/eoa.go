...
func NewEOA(dataPoster *dataposter.DataPoster, rollupAddress common.Address, l1Client METAutil.L1Interface, getExtraGas func() uint64) (*EOA, error) {
	return &EOA{
...
func (w *EOA) L1Client() METAutil.L1Interface {
	return w.client
}
