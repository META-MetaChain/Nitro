...
func (m *MessagePruner) UpdateLatestConfirmed(count METAutil.MessageIndex, globalState validator.GoGlobalState) {
...
func (m *MessagePruner) prune(ctx context.Context, count METAutil.MessageIndex, globalState validator.GoGlobalState) error {
...
func (m *MessagePruner) deleteOldMessagesFromDB(ctx context.Context, messageCount METAutil.MessageIndex, delayedMessageCount uint64) error {
