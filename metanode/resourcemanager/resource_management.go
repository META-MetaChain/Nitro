...
var (
	limitCheckDurationHistogram = metrics.NewRegisteredHistogram("META/rpc/limitcheck/duration", nil, metrics.NewBoundedHistogramSample())
	limitCheckSuccessCounter    = metrics.NewRegisteredCounter("META/rpc/limitcheck/success", nil)
	limitCheckFailureCounter    = metrics.NewRegisteredCounter("META/rpc/limitcheck/failure", nil)
	nitroMemLimit               = metrics.GetOrRegisterGauge("META/memory/limit", nil)
	nitroMemUsage               = metrics.GetOrRegisterGauge("META/memory/usage", nil)
